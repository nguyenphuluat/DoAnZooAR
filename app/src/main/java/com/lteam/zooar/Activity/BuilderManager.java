...
public class BuilderManager {
    ...
    static TextOutsideCircleButton.Builder getTextOutsideCircleButtonBuilder(int position) {
        switch (position){
            case 0:return new TextOutsideCircleButton.Builder()
                    .normalImageRes(getImageResource())
                    .normalTextRes(R.string.changpass);
            case 1:return new TextOutsideCircleButton.Builder()
                    .normalImageRes(getImageResource())
                    .normalTextRes(R.string.changvatar);
            case 2:return new TextOutsideCircleButton.Builder()
                    .normalImageRes(getImageResource())
                    .normalTextRes(R.string.manageuser);
            case 3:return new TextOutsideCircleButton.Builder()
                    .normalImageRes(getImageResource())
                    .normalTextRes(R.string.modelmanager);
            default:return new TextOutsideCircleButton.Builder()
                    .normalImageRes(getImageResource())
                    .normalTextRes(R.string.app_name);
        }
    }
    ...
    static HamButton.Builder getHamButtonBuilderWithDifferentPieceColor(int position) {
        switch (position){
            case 0:return new HamButton.Builder()
                    .normalImageRes(getImageResource())
                    .normalTextRes(R.string.sceneform)
                    .subNormalTextRes(R.string.sceneform)
                    .pieceColor(Color.WHITE);
            case 1:return new HamButton.Builder()
                    .normalImageRes(getImageResource())
                    .normalTextRes(R.string.control)
                    .subNormalTextRes(R.string.control)
                    .pieceColor(Color.WHITE);
            case 2:return new HamButton.Builder()
                    .normalImageRes(getImageResource())
                    .normalTextRes(R.string.cloud)
                    .subNormalTextRes(R.string.cloud)
                    .pieceColor(Color.WHITE);
            case 3:return new HamButton.Builder()
                    .normalImageRes(getImageResource())
                    .normalTextRes(R.string.loguot)
                    .subNormalTextRes(R.string.loguot)
                    .pieceColor(Color.WHITE);
            case 4:return new HamButton.Builder()
                    .normalImageRes(getImageResource())
                    .normalTextRes(R.string.sort_view)
                    .subNormalTextRes(R.string.loguot)
                    .pieceColor(Color.WHITE);
            case 5:return new HamButton.Builder()
                    .normalImageRes(getImageResource())
                    .normalTextRes(R.string.sort_time)
                    .subNormalTextRes(R.string.loguot)
                    .pieceColor(Color.WHITE);
            case 6:return new HamButton.Builder()
                    .normalImageRes(getImageResource())
                    .normalTextRes(R.string.sort_enjoy)
                    .subNormalTextRes(R.string.loguot)
                    .pieceColor(Color.WHITE);
            default: return new HamButton.Builder()
                    .normalImageRes(getImageResource())
                    .normalTextRes(R.string.app_name)
                    .subNormalTextRes(R.string.app_name)
                    .pieceColor(Color.WHITE);
